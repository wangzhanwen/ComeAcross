...
public class CaptureLayout extends RelativeLayout {
    ...
    private TypeButton btn_editor;
    private ReturnButton btn_return;
    private TextView txt_tip;

    private int layout_width;
    private int layout_height;
    private int capturrebtn_size;
    ...
    public CaptureLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        capturrebtn_size = (int) (layout_width / 5f);
    ...
    public void initEvent() {
        ...
        btn_editor.setVisibility(INVISIBLE);
    }
    ...
    public void startTypeBtnAnimator() {
        ...
        btn_editor.setVisibility(VISIBLE);
    ...
    private void initView() {
        ...
        //btn_capture
        btn_capture = new CaptureButton(getContext(), capturrebtn_size);
        ...
        btn_capture_param.setMargins(0, 140, 0, 0);
        ...
        btn_editor = new TypeButton(getContext(), TypeButton.TYPE_EDITOR, button_size);
        LayoutParams btn_editor_param = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        btn_editor_param.addRule(CENTER_VERTICAL, TRUE);
        btn_editor_param.addRule(CENTER_HORIZONTAL, TRUE);
        btn_editor_param.setMargins(0, 0, (layout_width / 4) - button_size / 2, 0);
        btn_editor.setLayoutParams(btn_editor_param);
