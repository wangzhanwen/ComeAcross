package com.lyy_wzw.imageselector;
...
import com.lyy_wzw.imageselector.adapter.FolderAdapter;
import com.lyy_wzw.imageselector.adapter.ImageAdapter;
import com.lyy_wzw.imageselector.constant.Constants;
import com.lyy_wzw.imageselector.entry.Folder;
import com.lyy_wzw.imageselector.entry.Image;
import com.lyy_wzw.imageselector.model.ImageModel;
import com.lyy_wzw.imageselector.utils.DateUtils;
import com.lyy_wzw.imageselector.utils.ImageSelectorUtils;

import java.util.ArrayList;

public class ImageSelectorActivity extends AppCompatActivity {
    private static SelectResultListener mSelectResultListener;
     ...
     */
    public static void openActivity(Context context, SelectResultListener selectResultListener, boolean isSingle, int maxSelectCount) {
        ...
        mSelectResultListener = selectResultListener;
    ...
    private void confirm() {
        ...
        if (mSelectResultListener != null) {
            mSelectResultListener.onSelectResult(images);
        }
