...
public class DetailCommentVideoActivity extends AppCompatActivity {
    private static final String TAG = "DetailCommentVideoActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_comment_video);
    ...
    private void initView() {
        mUserPhotoImg    = (ImageView)findViewById(R.id.detail_video_recyclerView_item_user_photo);
        mUserNameTv      = (TextView)findViewById(R.id.detail_video_recyclerView_item_user_name);
        mContentTv       = (ExpandTextView)findViewById(R.id.detail_video_recyclerView_item_content);
        mLocationTv      = (TextView)findViewById(R.id.detail_video_recyclerView_item_location);
        mTimeTv          = (TextView)findViewById(R.id.detail_video_recyclerView_item_time);
        mPriseTv         = (TextView)findViewById(R.id.detail_video_recyclerView_item_praise);
        mCommentTv       = (TextView)findViewById(R.id.detail_video_recyclerView_item_comment);
        mCommentBodyView = (LinearLayout)findViewById(R.id.detail_video_comment_body);
        mPraiseListView  = (PraiseListView)findViewById(R.id.detail_video_praise_listView);
        mCommentListView = (CommentListView)findViewById(R.id.detail_video_comment_listview);
        mCommentLineView = findViewById(R.id.detail_video_comment_line);
        mVideoBgImg      = (ImageView)findViewById(R.id.detail_video_recyclerView_item_video_bg);
        mVideoPlayImg    = (ImageView)findViewById(R.id.detail_video_recyclerView_item_video_play);
        mCommentEt       = (EditText) findViewById(R.id.detail_video_comment_editview);
        mCommentSendTv   = (TextView) findViewById(R.id.detail_video_comment_send_tv);
        mCommentContainerView = (LinearLayout) findViewById(R.id.detail_video_comment_container);
        mRootView        = (FrameLayout) findViewById(R.id.detail_video_root_view);

        mRootView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SoftInputUtil.hideSoftInput(DetailCommentVideoActivity.this, mCommentEt);
    ...
    private void initData() {
        ...
        UserHelper.getInstance().queryUser("objectId", userId, new UserHelper.UserQueryCallback() {
            ...
            public void onResult(List<CAUser> users, BmobException e) {
                ...
                if (users != null && users.size() > 0) {
                    ...
                    if (caUser != null) {
                        GlideUtil.loadPic(DetailCommentVideoActivity.this, caUser.getUserPhoto(), mUserPhotoImg);
        ...
        //根据媒体文件
        if (getType(mFootPrint) == 2) {
            GlideUtil.loadPic(DetailCommentVideoActivity.this, mFootPrint.getFootPrintFiles().get(0).getThumbnailPath(), mVideoBgImg);
        }
        ...
        mCommentTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SoftInputUtil.showSoftInput(DetailCommentVideoActivity.this, mCommentEt);
                proCommentMsg(-1,0);
            ...
            public void onItemLongClick(int position) {
                ...
                if (commentItem != null) {
                    if (!commentItem.getUser().getObjectId().equals(UserHelper.getInstance().getCurrentUser().getObjectId())) {
                        Toast.makeText(DetailCommentVideoActivity.this, "对不起，没有权限删除此条评论.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                } else {
                    return;
        ...
        mCommentListView.setOnItemUserClickListener(new CommentListView.OnItemUserClickListener() {
            ...
            public void onItemUserClick(String userId) {
                Toast.makeText(DetailCommentVideoActivity.this, "点击评论用户-> userId:" + userId, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mPraiseListView.setOnItemClickListener(new PraiseListView.OnItemClickListener() {
            ...
            public void onClick(int position) {
                Toast.makeText(DetailCommentVideoActivity.this, "点击点赞用户-> position:" + position, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mFootPrint.update(mFootPrint.getObjectId(), new UpdateListener() {
                    ...
                    public void done(BmobException e) {
                        if (e==null) {
                            Toast.makeText(DetailCommentVideoActivity.this, "删除成功.", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(DetailCommentVideoActivity.this, "删除失败.", Toast.LENGTH_SHORT).show();
                            if (mFootPrint.getComments() != null) {
                                mCommentListView.setDatas(mFootPrint.getComments());
                            }
                        }
        ...
        mCommentSendTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(content)){
                    Toast.makeText(DetailCommentVideoActivity.this, tipMsg, Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mFootPrint.update(mFootPrint.getObjectId(), new UpdateListener() {
                    @Override public void done(BmobException e) {
                        ...
                        if (e==null) {
                            ...
                            Toast.makeText(DetailCommentVideoActivity.this, "评论失败.", Toast.LENGTH_SHORT).show();
