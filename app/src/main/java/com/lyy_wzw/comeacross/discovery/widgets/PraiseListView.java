...
import com.lyy_wzw.comeacross.discovery.spannable.CircleMovementMethod;
import com.lyy_wzw.comeacross.discovery.spannable.SpannableClickable;
...
public class PraiseListView extends TextView{
    ...
    public void setDatas(List<PraiseItem> datas) {
        this.datas = datas;
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(InitApplication.getContext(), R.mipmap.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
