...
public class PermissionHelper {
    ...
    public PermissionHelper rationale(String rationale) {
    ...
    public PermissionHelper positveButtonText(@StringRes int positiveButtonText) {
        this.mPositiveButtonText = positiveButtonText;
        return this;
    }

    public PermissionHelper nagativeButtonText(@StringRes int negativeButtonText) {
     ...
     * 使用{@link PermissionHelper#hasPermissions(Context, String...)}进行判断
     *
